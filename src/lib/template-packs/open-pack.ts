...
const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    category: "business",
    description: "Facilitation slides for planning workshops.",
  ...
  },
  {
    ...
    name: "Brand Story",
    category: "marketing",
    description: "Narrative brand slides for partners and press.",
  ...
  },
  {
    ...
    category: "events",
    description: "Bold stage slides with few words per slide.",
  ...
  },
  {
    ...
    name: "Pricing Review",
    category: "product",
    description: "Packaging and pricing recommendation slides.",
